...
import qbf.javassist.bytecode.StackMapTable.InsertLocal;
import qbf.javassist.bytecode.StackMapTable.NewRemover;
import qbf.javassist.bytecode.StackMapTable.Shifter;
...
public class StackMap extends AttributeInfo {
     ...
     *
     * @see qbf.javassist.CtBehavior#addParameter(qbf.javassist.CtClass)
