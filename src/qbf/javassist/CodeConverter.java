 ...
 *
 * @see qbf.javassist.CtClass#instrument(CodeConverter)
 * @see qbf.javassist.CtMethod#instrument(CodeConverter)
 * @see qbf.javassist.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see qbf.javassist.CtMethod#setName(String)
     */
