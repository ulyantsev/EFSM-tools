...
import qbf.javassist.bytecode.AccessFlag;
import qbf.javassist.bytecode.AnnotationsAttribute;
import qbf.javassist.bytecode.AttributeInfo;
import qbf.javassist.bytecode.BadBytecode;
import qbf.javassist.bytecode.Bytecode;
import qbf.javassist.bytecode.ClassFile;
import qbf.javassist.bytecode.CodeAttribute;
import qbf.javassist.bytecode.CodeIterator;
import qbf.javassist.bytecode.ConstPool;
import qbf.javassist.bytecode.ConstantAttribute;
import qbf.javassist.bytecode.Descriptor;
import qbf.javassist.bytecode.EnclosingMethodAttribute;
import qbf.javassist.bytecode.FieldInfo;
import qbf.javassist.bytecode.InnerClassesAttribute;
import qbf.javassist.bytecode.MethodInfo;
import qbf.javassist.bytecode.ParameterAnnotationsAttribute;
import qbf.javassist.bytecode.SignatureAttribute;
import qbf.javassist.bytecode.annotation.Annotation;
import qbf.javassist.compiler.AccessorMaker;
import qbf.javassist.compiler.CompileError;
import qbf.javassist.compiler.Javac;
import qbf.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see qbf.javassist.CtClass#prune()
     * @see qbf.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
