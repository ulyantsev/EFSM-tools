...
public abstract class CtClass {
     ...
     */
    public qbf.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see qbf.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see qbf.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     * @see qbf.javassist.bytecode.SignatureAttribute.MethodSignature#encode()
     ...
     * @see qbf.javassist.bytecode.Descriptor
     */
     ...
     *
     * @see qbf.javassist.CtConstructor
     */
     ...
     *
     * @see qbf.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see qbf.javassist.CtField.Initializer#byExpr(String)
     * @see qbf.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see qbf.javassist.bytecode.AttributeInfo
     */
