 ...
 *
 * @see qbf.javassist.CtClass
 * @see qbf.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see qbf.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see qbf.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see qbf.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see qbf.javassist.ByteArrayClassPath
     */
     ...
     * @see qbf.javassist.ClassPath
     * @see qbf.javassist.URLClassPath
     * @see qbf.javassist.ByteArrayClassPath
     */
