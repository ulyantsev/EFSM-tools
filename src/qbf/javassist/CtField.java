...
import qbf.javassist.bytecode.*;
import qbf.javassist.compiler.CompileError;
import qbf.javassist.compiler.Javac;
import qbf.javassist.compiler.SymbolTable;
import qbf.javassist.compiler.ast.ASTree;
import qbf.javassist.compiler.ast.DoubleConst;
import qbf.javassist.compiler.ast.IntConst;
import qbf.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link qbf.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see qbf.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link qbf.javassist.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see qbf.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see qbf.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
