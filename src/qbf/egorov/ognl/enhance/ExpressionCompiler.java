package qbf.egorov.ognl.enhance;
...
public class ExpressionCompiler implements OgnlExpressionCompiler {
    ...
    /**
     * Used by {@link #castExpression(qbf.egorov.ognl.OgnlContext, qbf.egorov.ognl.Node, String)} to store the cast java
    ...
    /**
     * Used by {@link #getRootExpression(qbf.egorov.ognl.Node, Object, qbf.egorov.ognl.OgnlContext)} to determine if the expression
...
//        System.out.println("Setter Body: ===================================\n" + body);
     ...
     *          The current execution context.
     * @param loader
     *          The {@link ClassLoader} instance to use - as returned by {@link #getClassLoader(qbf.egorov.ognl.OgnlContext)}.
