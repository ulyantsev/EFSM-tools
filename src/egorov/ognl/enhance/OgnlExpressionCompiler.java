...
public interface OgnlExpressionCompiler {
     ...
     * always return a {@link Node} with a non null {@link egorov.ognl.Node#getAccessor()} instance - unless an exception
    ...
    /**
     * Used primarily by AST types like {@link egorov.ognl.ASTChain} where <code>foo.bar.id</code> type references
     * may need to be cast multiple times in order to properly resolve the members in a compiled statement.
     *
     * <p>
     * This method should be using the various {@link egorov.ognl.OgnlContext#getCurrentType()} / {@link egorov.ognl.OgnlContext#getCurrentAccessor()} methods
