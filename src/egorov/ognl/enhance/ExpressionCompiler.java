...
public class ExpressionCompiler implements OgnlExpressionCompiler {
    ...
    /**
     * Used by {@link #castExpression(egorov.ognl.OgnlContext, egorov.ognl.Node, String)} to store the cast java
    ...
    /**
     * Used by {@link #getRootExpression(egorov.ognl.Node, Object, egorov.ognl.OgnlContext)} to determine if the expression
...
//        System.out.println("Setter Body: ===================================\n" + body);
     ...
     *          The current execution context.
     * @param loader
     *          The {@link ClassLoader} instance to use - as returned by {@link #getClassLoader(egorov.ognl.OgnlContext)}.
