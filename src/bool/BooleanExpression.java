...
public class BooleanExpression {
     ...
     * standard dictionary
     *
     * @param expression the string to be parsed into a Boolean expression
     */
     ...
     *
     * @param expression the string to be parsed into a Boolean expression
     * @param userDict   the standard dictionary for this expression
     */
     ...
     *
     * @param str         the operator to evaluate using the values stack. Will be
     *                    modified by this method.
     * @param valuesStack the stack of values from which operands should be popped and
     *                    the result pushed
     */
     ...
     * </ul>
     *
     * @param dict dictionary of variables to values
     * @return the truth value of this BooleanExpression for the given
     * dictionary
     * @throws ParseException if this BooleanExpression is not properly formatted.
     */
