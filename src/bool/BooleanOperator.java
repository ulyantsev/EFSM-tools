...
public abstract class BooleanOperator {
     ...
     *
     * @param oper the string representing the BooleanOperator to return
     * @return the BooleanOperator represented by the given string
     ...
     *
     * @param oper the string representing an operator
     * @return true if oper represents an operator, else false
     */
     ...
     *
     * @param operands the operands for which to evaluate this operator
     * @return the truth value of this operator for the given operand(s)
     * @throws IllegalArgumentException if the number of operands does not equal the arity of this
     *                                  operator
     * @see #apply(boolean...)
     * @see #getArity()
     */
