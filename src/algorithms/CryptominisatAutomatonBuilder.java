...
public class CryptominisatAutomatonBuilder {
	public static Automaton build(ScenariosTree tree, int k) throws IOException {
		return build(tree, k, null);
	}	
	
	public static Automaton build(ScenariosTree tree, int k, PrintWriter cnfPrintWriter) throws IOException {
		return build(tree, k, cnfPrintWriter, null);
	}

	public static Automaton build(ScenariosTree tree, int k, PrintWriter cnfPrintWriter, PrintWriter solverPrintWriter)
			throws IOException {
